...
<!--            >-->
<!--                <div-->
<!--                    class="relative flex-none w-64 leading-5 w-full max-w-7xl"-->
...
<!--                            class="overflow-hidden relative w-full h-full bg-transparent rounded-lg shadow-md lg:aspect-w-16 lg:aspect-h-9"-->
...
<!--                                        </div>-->
                                    ...
                                    <!-- Darken the Photo -- both used to have max-h-screen max-w-screen  -->
        <img class="absolute h-full w-full object-cover top-0" :src="form.cover_photo"/>

        <div class="absolute h-full w-full object-cover top-0 bg-white opacity-60"/>
                                                                            ...
                                                                            <ul v-if="question.options.length" v-for="(option, index) in optionsList" role="listbox" class="f-radios">
                                                                                <li :aria-label="'Press ' + mcLetters[index] + ' to select'" role="option" class=""><!---->
                                                                                    <div class="f-label-wrap">
                                                                                        ...
                                                                                        <svg @click="deleteOption(option.uuid)" v-on:click.stop class="text-gray-700 right-3 h-5 w-5 pt-1" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
