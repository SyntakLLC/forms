    ...
    <jet-authentication-card>
        ...
        <form @submit.prevent="submit">
            <div>
                ...
                <input id="email" type="email" class="border-gray-300 focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" v-model="form.email" required autofocus />
            </div>
