            ...
            <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
                ...
                <div class="w-full sm:max-w-2xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SYNTAK, LLC, 409 Waverley Rd.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to AboutContact, accessible from <a href="www.about.contact" rel="external nofollow noopener" target="_blank">www.about.contact</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By visiting this page on our website: <a href="www.about.contact/help" rel="external nofollow noopener" target="_blank">www.about.contact/help</a></li>
                    </ul>
                </div>
            </div>
        </div>
