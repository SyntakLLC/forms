            ...
            <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
                ...
                <div class="w-full sm:max-w-2xl mt-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Homeform, accessible from <a href="www.homeform.app" rel="external nofollow noopener" target="_blank">www.homeform.app</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>By visiting this page on our website: <a href="www.homeform.app/help" rel="external nofollow noopener" target="_blank">www.homeform.app/help</a></li>
                    </ul>
                </div>
            </div>
        </div>
