<template>
    <app-layout>
        <!-- Initialized -->
        <div v-if="$page.props.site.initialized" class="h-full" :style="cssProps">
                                            ...
                                            <ul class="mt-2" v-if="$page['props']['forms'].length">
                                                        <li v-for="(form) in $page['props']['forms']"
                                                            ...
                                                            <inertia-link :href="route('form.edit', form.uuid)">
                                                                <div class="mb-5 bg-white hover:bg-gray-50 rounded-lg sm:mb-4 border">
                                            ...
                                            <div class="overflow-hidden relative w-full text-gray-700">
                                                <div class="flex overflow-scroll items-start py-px pr-12">
                                                    <div v-for="(property) in $page['props']['properties']"
                                                         @click="$inertia.get(route('property.edit', property.uuid))"
                                                         class="flex flex-col flex-none self-stretch pr-6 w-11/12">
                                                        <a
                                                            :href="route('property.edit', property.uuid)"
                                                    ...
                                                    <div class="w-full">
                                                        <div class="sm:ml-20 m-0">
                                                            <flow-form>
                                                                ...
                                                                <question type="text" placeholder="Type here..." title="What is your name?" v-model="name" required></question>
                                                                <question type="sectionbreak" :title="'Nice to meet you, ' + name + '.'" subtitle="I'd love to get to know you. Fill out some contact information and I'll reach out shortly."></question>
