            ...
            <div class="hidden lg:flex lg:flex-shrink-0">
                <div class="flex flex-col w-64 border-r border-gray-200 pt-5 pb-4 bg-gray-100">
                    ...
                    <div class="h-0 flex-1 flex flex-col overflow-y-auto">
                        ...
                        <div class="px-3 mt-6 relative inline-block text-left">
                            <div>
                                ...
                                <!--ACTIVE-->
                                <button v-if="showingProfileMenu" @click="showingProfileMenu=!showingProfileMenu"
                                        type="button"
                                        class="group w-full bg-gray-200 rounded-md px-3.5 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-purple-500"
                                        ...
                                        <span class="flex w-full justify-between items-center">
                                            <span class="flex min-w-0 items-center justify-between space-x-3">
                                                ...
                                                <!--                                                &lt;!&ndash;                                            <span class="flex-1 flex-col min-w-0">&ndash;&gt;-->
                                                <!--                                                        <span class="text-gray-900 text-sm font-medium truncate">{{-->
                                                <!--                                                                $page.props.user.name + " | " + $page.props.user.email-->
                                                <!--                                                            }}</span>-->
                                                <!--                                                &lt;!&ndash;                                                </div>&ndash;&gt;-->
                                                <!--                                                &lt;!&ndash;                                                <div>&ndash;&gt;-->
                                                <!--                                                &lt;!&ndash;                                                    <span class="text-gray-500 text-sm whitespace-pre-line truncate">&ndash;&gt;-->
                                                <!--                                                &lt;!&ndash;                                                            {{ $page.props.user.email }}&ndash;&gt;-->
                                                <!--                                                &lt;!&ndash;                                                    </span>&ndash;&gt;-->
                                                <!--                                                &lt;!&ndash;                                                </div>&ndash;&gt;-->
                                                <!--                                                &lt;!&ndash;                                            </span>&ndash;&gt;-->
                    ...
                    <span class="text-gray-500 text-left text-sm truncate">{{ $page.props.user.email }}</span>
                                ...
                                <!--INACTIVE-->
                                <button v-else @click="showingProfileMenu=!showingProfileMenu"
                                        type="button"
                        ...
                        <transition enter-active-class="transition ease-out duration-100"
                            ...
                            <div v-show="showingProfileMenu"
                                 class="z-10 mx-3 mt-1 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y divide-gray-200 focus:outline-none"
                                ...
                                <div class="py-1 hover:bg-gray-50" role="none">
                                    ...
                                    <button @click="$inertia.get(route('profile.show'))"
                                            class="text-gray-700 block px-4 py-2 text-sm focus:outline-none w-full h-full text-left" role="menuitem" tabindex="-1"
                                            id="options-menu-item-0">View profile
                                    </button>
                                </div>
                                <div class="py-1 hover:bg-gray-50" role="none">
                                    <button @click="$inertia.post(route('logout'))"
                                            class="text-gray-700 block px-4 py-2 text-sm focus:outline-none w-full h-full text-left" role="menuitem" tabindex="-1"
                                            id="options-menu-item-5">Logout
                                    </button>
                                </div>
                            </div>
                        </transition>
